...
##############################################################
#    C1P_make_mC1P_heuristic.py
#
#    Given a set of weighted ACS including telomeric ones, 
#    compures a subset that is mC1P by adding
#    higher weighted ACS first (greedy heuristic).
#
##############################################################

if len(sys.argv) < 3:
        print "Use a greedy heuristic to compute a set of ACS that satisfies the mC1P"
        print ""
        print "Usage:"
        print "C1P_make_mC1P_heuristic InputACSFile OutputACSFile RemovedACSFile"
        print '   Input:'
